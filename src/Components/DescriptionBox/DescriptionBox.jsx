    ...
    return (
        <div className="descriptionbox">
          ...
          <div className="descriptionbox-description">
            <p>An e-commerce website is an online platform where businesses and individuals 
        ...
        operations.</p>
        <p>
        E-commerce website is a digital storefront for buying and selling goods 
        ...
        businesses with global customers, making shopping more convenient and efficient.
        </p>
          </div>
